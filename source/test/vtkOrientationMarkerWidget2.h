...
#ifndef vtkOrientationMarkerWidget2_h
#define vtkOrientationMarkerWidget2_h
...
class vtkOrientationMarkerWidget2 : public vtkInteractorObserver
{
public:
  static vtkOrientationMarkerWidget2* New();
  vtkTypeMacro(vtkOrientationMarkerWidget2, vtkInteractorObserver);
...
protected:
  vtkOrientationMarkerWidget2();
  ~vtkOrientationMarkerWidget2() override;
...
private:
  vtkOrientationMarkerWidget2(const vtkOrientationMarkerWidget2&) = delete;
  void operator=(const vtkOrientationMarkerWidget2&) = delete;
