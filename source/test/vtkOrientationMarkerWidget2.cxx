...
vtkStandardNewMacro(vtkOrientationMarkerWidget2);

vtkCxxSetObjectMacro(vtkOrientationMarkerWidget2, OrientationMarker, vtkProp);
...
public:
  ...
  vtkOrientationMarkerWidget2* OrientationMarkerWidget;
};

//------------------------------------------------------------------------------
vtkOrientationMarkerWidget2::vtkOrientationMarkerWidget2()
{
  this->StartEventObserverId = 0;
  this->EventCallbackCommand->SetCallback(vtkOrientationMarkerWidget2::ProcessEvents);
  ...
  this->Renderer->SetLayer(3);
  this->Renderer->InteractiveOff();

  this->Priority = 0.55;
  this->OrientationMarker = nullptr;
  this->State = vtkOrientationMarkerWidget2::Outside;
  this->Interactive = 1;
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SetEnabled(int value)
{
  if (!this->Interactor)
  {
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SetupWindowInteraction()
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::TearDownWindowInteraction()
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ExecuteCameraUpdateEvent(
...
//------------------------------------------------------------------------------
int vtkOrientationMarkerWidget2::ComputeStateBasedOnPosition(int X, int Y, int* pos1, int* pos2)
{
  if (X < (pos1[0] - this->Tolerance) || (pos2[0] + this->Tolerance) < X ||
    Y < (pos1[1] - this->Tolerance) || (pos2[1] + this->Tolerance) < Y)
  {
    return vtkOrientationMarkerWidget2::Outside;
  }
  ...
  int result =
    this->Moving ? vtkOrientationMarkerWidget2::Translating : vtkOrientationMarkerWidget2::Inside;
  ...
  if (e1)
  {
    if (e2)
    {
      result = vtkOrientationMarkerWidget2::AdjustingP1; // lower left
    }
    if (e4)
    {
      result = vtkOrientationMarkerWidget2::AdjustingP4; // upper left
    }
  }
  if (e3)
  {
    if (e2)
    {
      result = vtkOrientationMarkerWidget2::AdjustingP2; // lower right
    }
    if (e4)
    {
      result = vtkOrientationMarkerWidget2::AdjustingP3; // upper right
    }
  }
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SetCursor(int state)
{
  switch (state)
  {
    case vtkOrientationMarkerWidget2::AdjustingP1:
      this->RequestCursorShape(VTK_CURSOR_SIZESW);
      break;
    case vtkOrientationMarkerWidget2::AdjustingP3:
      this->RequestCursorShape(VTK_CURSOR_SIZENE);
      break;
    case vtkOrientationMarkerWidget2::AdjustingP2:
      this->RequestCursorShape(VTK_CURSOR_SIZESE);
      break;
    case vtkOrientationMarkerWidget2::AdjustingP4:
      this->RequestCursorShape(VTK_CURSOR_SIZENW);
      break;
    case vtkOrientationMarkerWidget2::Translating:
      this->RequestCursorShape(VTK_CURSOR_SIZEALL);
      break;
    case vtkOrientationMarkerWidget2::Inside:
      this->RequestCursorShape(VTK_CURSOR_SIZEALL);
      break;
    case vtkOrientationMarkerWidget2::Outside:
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ProcessEvents(
  vtkObject* vtkNotUsed(object), unsigned long event, void* clientdata, void* vtkNotUsed(calldata))
{
  vtkOrientationMarkerWidget2* self = reinterpret_cast<vtkOrientationMarkerWidget2*>(clientdata);
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::EndInteraction()
{
  this->OnLeftButtonUp();
...
//-------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::OnLeftButtonDown()
{
  ...
  if (this->State == vtkOrientationMarkerWidget2::Outside)
  {
    this->Moving = 0;
    return;
  }
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::OnLeftButtonUp()
{
  if (this->State == vtkOrientationMarkerWidget2::Outside)
  {
    return;
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SquareRenderer()
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::UpdateOutline()
{
  double vp[4];
  this->Renderer->GetViewport(vp);
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SetInteractive(vtkTypeBool interact)
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::OnMouseMove()
{
  ...
  if (this->State == vtkOrientationMarkerWidget2::Outside || !this->Moving)
  {
    this->Interactor->Render();
    return;
  }
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::MoveWidget(int X, int Y)
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ResizeTopLeft(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ResizeTopRight(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
  int delta = (abs(dx) + abs(dy)) / 2;
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ResizeBottomRight(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
  int delta = (abs(dx) + abs(dy)) / 2;
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ResizeBottomLeft(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
  int delta = (abs(dx) + abs(dy)) / 2;
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SetOutlineColor(double r, double g, double b)
{
...
//------------------------------------------------------------------------------
double* vtkOrientationMarkerWidget2::GetOutlineColor()
{
  return this->OutlineActor->GetProperty()->GetColor();
}

//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::UpdateViewport()
{
  if (!this->CurrentRenderer)
  {
    return;
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::UpdateInternalViewport()
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::Modified()
{
  this->UpdateInternalViewport();
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::PrintSelf(ostream& os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::SetShouldConstrainSize(const vtkTypeBool shouldConstrainSize)
{
...
//------------------------------------------------------------------------------
bool vtkOrientationMarkerWidget2::SetSizeConstraintDimensionSizes(
...
//------------------------------------------------------------------------------
void vtkOrientationMarkerWidget2::ResizeToFitSizeConstraints()
{
  if (!this->ShouldConstrainSize)
  {
    return;
